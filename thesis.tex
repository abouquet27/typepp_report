...
My project: Explain Type confusion, the Hextype solution, the Typepp solution, aim of the paper and explain the results
+\nb{the goal of this project is benchmark for type confusion. You should argue
+tc are a problem. we want to compare tools. no need to introduce the different
+techniques here}
...
3. Explain the aim of the benchmark and how he achieves it
...
Create Benchmark to measure time ??
