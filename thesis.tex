...
\texttt{\textbf{static\_cast}<target-type>(expression)} cast an expression to a specified type and checks only compile-time without any runtime check. Therefore, this reduces cast verification to checking the types 
